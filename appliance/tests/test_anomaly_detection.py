...
from appliance.src.security.anomaly_detection import AnomalyDetector, detect_anomaly
from appliance.src.security.anomaly_detection import main as anomaly_main
